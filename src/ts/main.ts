...
module RecoTwExplorer {
    ...
    class Model {
        ...
        private static TWITTER_PROFILE_IMAGE_URL = "https://homo.chitoku.jp/checker/icon.php?username={0}";
        private static RECOTW_GET_ALL_URL = "https://api.recotw.hinaloe.net/1/tweet/get_tweet_all";
        private static RECOTW_POST_URL = "https://api.recotw.hinaloe.net/1/tweet/record_tweet";
        private static RECOTW_COUNT_URL = "https://api.recotw.hinaloe.net/1/tweet/count_tweet";
